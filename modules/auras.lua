...
if( not DebuffTypeColor ) then
	DebuffTypeColor = {
		none = DEBUFF_TYPE_NONE_COLOR or { r = 0.8, g = 0, b = 0 },
		Magic = DEBUFF_TYPE_MAGIC_COLOR or { r = 0, g = 0.6, b = 1 },
		Curse = DEBUFF_TYPE_CURSE_COLOR or { r = 0.6, g = 0, b = 0.8 },
		Disease = DEBUFF_TYPE_DISEASE_COLOR or { r = 0.6, g = 0.4, b = 0 },
		Poison = DEBUFF_TYPE_POISON_COLOR or { r = 0, g = 0.6, b = 0 },
	}
end
